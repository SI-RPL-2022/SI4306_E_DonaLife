                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="d-flex align-items-center bg-light-warning rounded p-5 mb-7">
                                ...
                                <div class="flex-grow-1 me-2">
                                    <a href="#" class="fw-bolder text-gray-800 text-hover-primary fs-6">Total User</a>
                            ...
                            <div class="d-flex align-items-center bg-light-success rounded p-5 mb-7">
                                ...
                                <!--begin::Title-->
                                <div class="flex-grow-1 me-2">
                                    <a href="#" class="fw-bolder text-gray-800 text-hover-primary fs-6">Uang Campaign</a>
                                    {{-- <span class="text-muted fw-bold d-block">Due in 2 Days</span> --}}
                                </div>
                                <!--end::Title-->
                                <!--begin::Lable-->
                            ...
                            <div class="d-flex align-items-center bg-light-danger rounded p-5 mb-7">
                                ...
                                <!--begin::Title-->
                                <div class="flex-grow-1 me-2">
                                    <a href="#" class="fw-bolder text-gray-800 text-hover-primary fs-6">Barang Campaign</a>
                            ...
                            <div class="d-flex align-items-center bg-light-info rounded p-5">
                                ...
                                <!--begin::Title-->
                                <div class="flex-grow-1 me-2">
                                    <a href="#" class="fw-bolder text-gray-800 text-hover-primary fs-6">Paket</a>
